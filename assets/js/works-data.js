...
const worksData = {
    ...
    all: [
        ...
        { type: 'coming-soon', vivivitUrl: 'https://www.vivivit.com/works/920584', badge: 'アプリ内ライブ演出', categories: ['プロジェクションマッピング', 'ライブ', 'アプリ内演出制作', 'チーム制作'] },
        { type: 'coming-soon', vivivitUrl: 'https://www.vivivit.com/works/916542', badge: 'MV', categories: ['ミュージックビデオ', 'モーションキャプチャー', 'ディレクション', 'チーム制作'] },
        { type: 'coming-soon', vivivitUrl: 'https://www.vivivit.com/works/822778', badge: 'WebAR', categories: ['WebAR', 'モデリング', 'プログラミング', 'ディレクション', '個人制作'] },
        {
